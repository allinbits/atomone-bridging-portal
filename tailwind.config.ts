...
export default <Config>{
  ...
  theme: {
    ...
    fontSize: {
      ...
      50: [
        `${pxToRem(8)}rem`,
        { lineHeight: `${pxToRem(10)}rem` }
      ],
      75: [
        `${pxToRem(11)}rem`,
        { lineHeight: `${pxToRem(13)}rem` }
      ],
      100: [
        `${pxToRem(13)}rem`,
      ...
      700: [
        `${pxToRem(40)}rem`,
        { lineHeight: `${pxToRem(48)}rem` }
      ],
      800: [
        `${pxToRem(48)}rem`,
        { lineHeight: `${pxToRem(56)}rem` }
      ],
      900: [
        `${pxToRem(56)}rem`,
        { lineHeight: `${pxToRem(64)}rem` }
      ],
      1000: [
        `${pxToRem(72)}rem`,
        { lineHeight: `${pxToRem(80)}rem` }
      ]
    }
  },
  safelist: [
